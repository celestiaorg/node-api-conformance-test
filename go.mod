module github.com/celestiaorg/node-api-conformance-test

go 1.22.2

require (
	github.com/celestiaorg/celestia-node v0.13.6
...
require (
	...
	github.com/celestiaorg/celestia-app v1.8.0 // indirect
